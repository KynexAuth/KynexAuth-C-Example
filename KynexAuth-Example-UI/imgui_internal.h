...
namespace ImGui
{
    ...
    IMGUI_API bool          Tab(const char* label, bool selectable, const ImVec2& size_arg = ImVec2(0, 0));
    IMGUI_API bool          ButtonTab(ImTextureID image, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Button_Icon(const char* label, ImTextureID image, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
