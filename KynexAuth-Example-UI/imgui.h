...
namespace ImGui
{
    ...
    IMGUI_API bool          Checkbox_Esp(const char* label, bool* v);
	...
	IMGUI_API bool          BeginCombo(const char* label, ImTextureID image, const char* preview_value, float val, float width, bool multi = 0, ImGuiComboFlags flags = 0);
	IMGUI_API void          EndCombo(); // only call EndCombo() if BeginCombo() returns true!
	IMGUI_API bool          Combo(const char* label, ImTextureID image, int* current_item, bool(*items_getter)(void*, int, const char**), void* data, int items_count, int popup_max_height_in_items = -1, float width = 180);
	IMGUI_API bool          Combo(const char* label, ImTextureID image, int* current_item, const char* const items[], int items_count, int height_in_items, float width);
	IMGUI_API bool          Combo(const char* label, ImTextureID image, int* current_item, const char* items_separated_by_zeros, int popup_max_height_in_items = -1);
